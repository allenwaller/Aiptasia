...
```{r}
#Import data set
edhw = read.csv("~/Library/CloudStorage/Box-Box/grp-sas-bio-barottlab/Data/2022 CC7 heat stress experiment/Code Cleaned for Publication/Temperature Data/edhw.csv")

#This data set contains the cumulative eDHW value for each day of the experiment for aposymbiotic and symbiotic replicates for each temperature treatment
#The final days of the experiment contain the total eDHW (reported in figure _) the animals experienced 
```

# Experimental temperature data
```{r}
#Import data set
temperature = read.csv("~/Library/CloudStorage/Box-Box/grp-sas-bio-barottlab/Data/2022 CC7 heat stress experiment/Code Cleaned for Publication/Temperature Data/temperature.csv")
...
dailyAverage = read.csv("~/Library/CloudStorage/Box-Box/grp-sas-bio-barottlab/Data/2022 CC7 heat stress experiment/Code Cleaned for Publication/Temperature Data/dailyAverage.csv")
